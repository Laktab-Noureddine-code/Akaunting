<template>
    <base-input
        ...
        :class="[{ readonly: readonly }, { disabled: disabled }, formClasses]"
        :error="formError"
    >
        <div class="flex justify-between relative mt-1" ref="reference">
            ...
            <div
                class="absolute w-7 h-7 flex rounded-full my-auto bottom-2 ltr:right-2 rtl:left-2 cursor-pointer"
                ref="dropdownMenu"
                @click="openPalette"
                :class="`bg-${color}`"
                :style="
                            ...
                            <div v-for="color in colors" :key="color">
                                <div
                                    ...
                                    :class="[
                                        `bg-${color}-${variant}`,
                                        small
                                            ? 'w-6 h-6 lg:w-4 lg:h-4'
                                            : 'w-8 h-8 xl:w-6 xl:h-6 2xl:w-8 2xl:h-8',
                                    ]"
...
export default {
    ...
    watch: {
        ...
        inputWidth() {
            this.minWidth =
                this.$refs.reference.getBoundingClientRect().width + "px";
        },
